...
public class PrintUtils implements Printable {
    protected final Logger logger = LoggerFactory.getLogger(PrintUtils.class);

    private String jobName;                              // 列印名稱
    private String printerName;                          // 設定印表機名稱
    private Map<Integer, List<PrintContent>> contentMap; // key = 頁碼, value = 列印內容及字型大小風格設定
